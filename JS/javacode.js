...
function mhide2() {
  document.getElementById('newzmid2').style.display = "none";
}

function mshow2() {
  document.getElementById('newzmid2').style.display = "block";
}

function mhide1() {
  document.getElementById('newzmid1').style.display = "none";
}

function mshow1() {
  document.getElementById('newzmid1').style.display = "block";
}
